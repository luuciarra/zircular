	...
	<body>
		...
		<div class="container-fluid main-container">
			...
			<div class="row">
				<div elem="1" class="item col port-container pointer port-color-reposicion-bg" >
					<h6 class="port-main-title port-color-reposicion">Titulo principal</h6>
					<p class="port-main-subtitle">Subtitulo</p>
					<p class="port-title">Título</p>
				</div>
				<div elem="2" class="item col port-container pointer port-color-altura-bg" >
					<h6 class="port-main-title port-color-altura">Titulo principal</h6>
					<p class="port-main-subtitle">Subtitulo</p>
					<p class="port-title">Título</p>
				</div>
				<div elem="3" class="item col port-container pointer port-color-mixto-bg" >
					<h6 class="port-main-title port-color-mixto">Titulo principal</h6>
					<p class="port-main-subtitle">Subtitulo</p>
					<p class="port-title">Título</p>
				</div>
				<div elem="4" class="item col port-container  pointer port-color-trabajo-bg" >
					<h6 class="port-main-title port-color-trabajo">Titulo principal</h6>
					<p class="port-main-subtitle">Subtitulo</p>
					<p class="port-title">Título</p>
				</div>
			</div>
			<div class="row">
				...
				<div elem="6" class="item col port-container pointer port-color-residencial-bg" >
					<h6 class="port-main-title port-color-residencial">Titulo principal</h6>
					<p class="port-main-subtitle">Subtitulo</p>
					<p class="port-title">Título</p>
				</div>
			...
			<div class="row">
				...
				<div elem="16" class="item col port-container pointer port-color-mixto-bg" >
					<h6 class="port-main-title port-color-mixto">Titulo principal</h6>
					<p class="port-main-subtitle">Subtitulo</p>
					<!-- <p class="port-image"><i class="fa fa-home fa-5x" aria-hidden="true"></i></p> -->
					<p class="port-title">Título</p>
				</div>
			</div>
		</div>
		...
		<div class="container-fluid work-single" >
			...
			<div class="row align-items-end work-row-1" >
				<h1 class="work-title">Lorem ipsum</h1>
			</div>
